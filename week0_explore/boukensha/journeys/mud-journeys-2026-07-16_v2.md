...
3. `journeys/mud-journeys-2026-07-16_v3.md` (Grundregel und Erfahrungen)
...
6. `../../logs/mud-journeys-2026-07-16_v4.log` (nur als optionale Auswege, als subagents nutzen `/btw`, nicht als Pflichtplan)
