...
The `data/` directory is at the project root, alongside `agents/` and
`scripts/` — read/write `data/player.md` and `data/world.md` relative to your
working directory.
...
```bash
SCRIPT=scripts/mud.py   # relative to the project root
