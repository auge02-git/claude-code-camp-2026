...
class Config:
    ...
    def save_prompt(self, task: str, prompt_name: str, content: str) -> Path:
        """Speichert einen Prompt unter .boukensha/prompts/<task>/<name>.md."""
        prompt_dir = self.user_prompts_dir / task
