...
def run_step5(config_dir: Path | None = None) -> int:
    ...
    # Debug view: letzter Context-Stand
    print()
    print("Context messages:")
    print(json.dumps([m.__dict__ for m in ctx.messages], indent=2, default=str))
    return 0


def main() -> None:
    raise SystemExit(run_step5())
